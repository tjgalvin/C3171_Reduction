...
# Load in the data
atlod = mu.mirstr(f"atlod in=raw/*C3171 options=notsys,rfiflag,birdie,xycorr,noauto,notsys ifsel={IFSEL} out=data{IFSEL}.uv").run()
print(atlod)
...
mu.flag_inttime(atlod.out, threshold=8, delete=True, logfile='dump7.txt', selection='flagging7.txt')
